...
function startGame() {
  var n = parseInt(document.getElementById("num").value); // Total individuals
  var m = parseInt(document.getElementById("sad").value); // Sad individuals

  if (isNaN(n) || isNaN(m) || m > n) {
    window.alert("Invalid input! Make sure you enter numbers and sad individuals do not exceed total individuals.");
    return;
  }
